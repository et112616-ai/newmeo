...
REPOSITORY_VERSION = "2026-07-27-v8.1-FAIR-ABLATION-KEYSET"
...
def load_market_prediction_rows_paginated(
    ...
    """以 ts 游標分頁讀取建立 V8.1 特徵所需的完整 OHLCV。"""
    ...
    try:
        ...
        print(
            "DEBUG market_prediction_repository_v8_1",
        ...
        print(
            "market_prediction_repository_v8_1 failed",
            "| start =", start_date,
            "| end =", end_date,
            "| rows =", len(rows),
            "| error =", repr(exc),
